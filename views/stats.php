...
<div class="uk-text-center uk-margin">
	...
	<h1 class="uk-heading-primary uk-margin-remove-top uk-margin-small-bottom uk-width-xxlarge uk-text-truncate"><?= $linkTitle ?></h1>
	<a class="uk-link-reset" target="_blank" href="<?= $link ?>"><span uk-icon="link"></span> <?= $link ?></a>
</div>
